			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
            	...
            	<div class="carousel-inner" role="listbox">
            		<div class="item active">
                    	<img class="first-slide home-image" src="resources/images/15.jpg" alt="first slide" >
                    	<div class="container">
                        	<div class="carousel-caption">
                            	<h1>WELCOME TO THE FOOD MONSTER</h1>
                            	<p>Eating is necessary but cooking is Art</p>
                        	</div>
                    	</div>
                	</div>
                	<div class="item">
                    	<img class="second-slide home-image" src="resources/images/13.jpg" alt="Second slide" >
                    	<div class="container">
                        	<div class="carousel-caption">
                            	<h1>FOOD MONSTER</h1>
                	...
                	<div class="item">
                    	<img class="third-slide home-image" src="resources/images/12.jpg" alt="third slide">
                    	<div class="container">
                        	<div class="carousel-caption">
                            	<h1>FOOD MONSTER</h1>
                	...
                	<div class="item">
                    	<img class="forth-slide home-image " src="resources/images/14.jpg" alt="forthforth slide">
                    	<div class="container">
                        	<div class="carousel-caption">
                        	    <h1>FOOD MONSTER</h1>
                 	...
                 	<div class="item">
                    	<img class="fifth-slide home-image " src="resources/images/111.jpg" alt="fifth slide">
                    	<div class="container">
                    	    <div class="carousel-caption">
                    	        <h1>FOOD MONSTER</h1>
